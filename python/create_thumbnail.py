...
dir_high = 'D:/HUHan/Web/vrlab/img/research/oringin'
dir_thumbnail = 'D:/HUHan/Web/vrlab/img/research/thumbnail'
...
for parent, dirnames, filenames in os.walk(dir_high):
    for filename in filenames:
        ...
        if fullpath_high.split('.')[-1].lower() == 'jpg' or\
            fullpath_high.split('.')[-1].lower() == 'png':
